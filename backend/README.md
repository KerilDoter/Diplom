...
X - Третья версия:
V Добавить поле is_moderated
V - Сделать так, чтобы статус был по умолчанию нет модератора 
TODO: V сделать миграцию, V - сделать статусы по умолчанию

X - Четвертая версия
V - Добавить поле user_id - нужно, для того чтобы указать кто автор статьи
...
login
password
rule_id (связь с таблицей роли / студент, преподаватель, модератор)
is_admin (bool)
about (о себе)
skills_id (связь с таблицей интересы / наверное скиллы)
...
# Комментарии
Внутри поста сделать форму, куда залогиненный пользователь пишет текст и
этот текст публикуется под постом в специальное место

# Страницы авторизации и регистрации

Будет общая страница с email, пароль и выбором студент или преподаватель
## Страница регистрации
Ссылка на страницу с логином
Поля:
- тип пользователя (выбирается из таблицы роли: преподаватель, студент)
- почта
- логин или почта (?)
- пароль
## Страница регистрации для студента (если выбрана роль студента)
То есть нажимается далее, отсылаются данные в роутер и там в зависимости
от того какая роль 
- Фамилия
- имя
- отчество
- номер телефона
- номер группы
Далее данные с прошлыми сохраняются в базу данных
! Можно get-запросом передать с 1 страницы

## Страница регистрации для преподавателя (если выбрана роль студента)
- Фамилия
- имя
- отчество
- номер телефона
